...
function MurmurHash64A(data8: Uint8Array, seed = 0x1337b33fn) {
  ...
  switch (remainder) {
    case 7:
      h ^= BigInt(data8[alignedLength + 6]) << 48n;
    case 6:
      h ^= BigInt(data8[alignedLength + 5]) << 40n;
    case 5:
      h ^= BigInt(data8[alignedLength + 4]) << 32n;
    case 4:
      h ^= BigInt(data8[alignedLength + 3]) << 24n;
    case 3:
      h ^= BigInt(data8[alignedLength + 2]) << 16n;
    case 2:
      h ^= BigInt(data8[alignedLength + 1]) << 8n;
    case 1:
      h ^= BigInt(data8[alignedLength + 0]) << 0n;
      h = BigInt.asUintN(64, h * m);
  }
